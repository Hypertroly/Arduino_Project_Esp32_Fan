...
const char* SSID = "dlink";                // SSID / nome da rede WiFi que vai ser conectada
const char* PASSWORD = "billypink";   // senha da rede WiFi que vai ser conectada
WiFiClient wifiClient;

const char* BROKER_MQTT = "iot.eclipse.org"; //URL do broker MQTT utilizado
int BROKER_PORT = 1883;

#define ID_MQTT  "TMP_MQTT_TIAGO"            //informando ID e tópicos do projeto 
